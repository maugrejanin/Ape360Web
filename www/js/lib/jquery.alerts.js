...
(function($) {
	...
	$.alerts = {
		...
		alert: function(message, title, callback) {
			if( title == null ) title = 'Amigo Secreto é na Hering';
		...
		_show: function(title, msg, value, type, callback) {
			...
			$("BODY").append(
			  '<div id="popup_container"><div id="popup_close"></div>' +
			...
			switch( type ) {
				case 'alert':
					...
					$("#popup_ok, #popup_close").focus();
					$("#popup_ok, #popup_close").keypress( function(e) {
